			...
			if(direction.equalsIgnoreCase("Hills")){
				...
				if (answer.equalsIgnoreCase("Yes")){
					...
					do{
						...
						if (counter==2)
							c.print("The man kills you");

					}while (counter<2 || answer.equalsIgnoreCase("wisdom") && answer.equalsIgnoreCase("Pain"));
									...
									if (direction.equalsIgnoreCase("Sneak around it")){
										...
										if (dice1<dice2){
											...
											if(direction.equalsIgnoreCase("go around")){
												c.clear();
												c.println("You go around the river and find a bridge and cross it");
												c.println(" the path leads you to the mountains to a cave where you see a sleeping dragon"
														+ " do you try to sneak attack or rush in and attack it ");
												c.println("1.Sneak Attack");
												c.println("2.Attack");
												direction = c.readLine();
											...
											if(direction.equalsIgnoreCase("Dodge")){
												...
												if (dice1<dice2)
													c.println("You seemed to have tripped on nothing, the dragons claw connects with your body the force of impact"
															+ "killing you immdietly");
												c.println("You have died");
												...
												if(direction.equalsIgnoreCase("Attack")){
													...
													if (dice1<dice2)
														c.println("You missed would you like to attack again?");
													direction= c.readLine();
											...
											if (direction .equalsIgnoreCase("Stay out")){
												...
												c.println("You run into a bear and die");
										...
										}else if(direction.equalsIgnoreCase("go around")){
											c.clear();
																...
																if (dice1<dice2){
																	...
																	if (dice1>dice2){
																		...
																		if(direction.equalsIgnoreCase("attack")){
																			...
																			if (dice1>dice2){
																				c.println("You charged in and stabbed it");
																				counter++;

																			}
																			if (dice1<dice2){
																				c.println("You miss and the dragon slashes at you killing you instantly.");
																				break;
																			}
																			else if (dice1==dice2){
																				c.println("The dragon kills you");
																				break;
																			}
																		}
